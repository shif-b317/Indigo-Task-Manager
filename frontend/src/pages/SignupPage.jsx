...
import { User, Mail, Lock, Eye, EyeOff, Layers, Loader2 } from 'lucide-react';
...
const SignupPage = () => {
  ...
  return (
    ...
    >
      {/* Decorative blobs */}
      <div className="absolute top-[-10%] left-[-10%] w-[35vw] h-[35vw] rounded-full bg-indigo-600/10 blur-[100px] pointer-events-none animate-pulse-slow" />
      <div className="absolute bottom-[-15%] right-[-15%] w-[40vw] h-[40vw] rounded-full bg-orange-300/5 blur-[120px] pointer-events-none" />
      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-xs opacity-60 mt-1 font-medium text-center">Get started with a clean productivity workspace.</p>
        </div>
        ...
        <p className="text-center text-xs opacity-70 mt-6">
          ...
          <Link to="/login" className="underline font-semibold hover:opacity-100 transition-opacity">
            Log In
          </Link>
        </p>
      </motion.div>
